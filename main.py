...
def test_residual_net():
    ...
    pnet = RNet()
    # Load the checkpoint
    checkpoint = torch.load('rnet_training/checkpoint/checkpoint_epoch_110.pth')
    # Load the model state dictionary
    pnet.load_state_dict(checkpoint)
    pnet.eval()

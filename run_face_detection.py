...
def predict_faces_in_image(im, window_size=None, min_pyramid_size=100, reduction_factor=0.7):
    ...
    pnet, pnet_resize = load_model_and_resize(PNet, 'pnet_training/checkpoint/best_checkpoint.pth', (12, 12))
    rnet, rnet_resize = load_model_and_resize(RNet, 'rnet_training/checkpoint/best_checkpoint.pth',(24, 24))
    onet, onet_resize = load_model_and_resize(ONet, 'onet_training/checkpoint/best_checkpoint.pth', (48, 48))

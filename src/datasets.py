...
class MTCNNDataset(Dataset):
    ...
    def __init__(self, path: str, partition: str, transform=None, neg_th: int = 0.3, pos_th: int = 0.65,
        ...
        self.path = path
        data_partition = pd.read_csv(os.path.join(path, "../data/celebA/images/list_bbox_celeba_align_and_crop.csv"), index_col=False)
        self.bbox = pd.read_csv(os.path.join(path, "../data/celebA/images/list_bbox_celeba_align_and_crop.csv"), index_col=False)
